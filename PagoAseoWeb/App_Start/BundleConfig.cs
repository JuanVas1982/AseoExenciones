    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/estilos").Include(
                        "~/Content/styles/jqx.base.css",
                        "~/Content/styles/jqx.alert.css",
                        "~/Content/styles/jqx.darkblue.css",
                        "~/Content/styles/jqx.metrodark.css",
                        "~/Content/styles/jqx.energyblue.css"));
